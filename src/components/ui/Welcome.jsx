  ...
  return (
    <div className="welcome-container">
      <Card className="welcome-card">
        <CardContent>
          <h2 className="welcome-title">Welcome to G.S Janja</h2>
          <p className="welcome-text">
            Welcome to the G.S Janja Gallery. Here, we showcase moments that reflect the vibrant life of our school community.
            ...
            the essence of learning and growth at G.S Janja. Every photo tells a story of dedication, joy, and the pursuit of excellence. 
